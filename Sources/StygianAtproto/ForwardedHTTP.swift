...
public enum ForwardedHTTP {
  public static func forwardedProto(from headers: HTTPFields) -> String? {
  ...
  public static func inferredScheme(forAuthority authority: String, headers: HTTPFields) -> String {
